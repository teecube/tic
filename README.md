...
This branch (*release-trigger-minor*) is a [**release trigger branch**](#release-trigger-branch) for the **T³ - TIC** project.
...
To trigger a new release with *minor* increment policy, simply [run a new pipeline](https://git.teecu.be/teecube/tic/pipelines/new) after selecting *release-trigger-minor* in the list.
That's it !
...
These versions numbers can also be [edited directly in Gitlab](https://git.teecu.be/teecube/tic/edit/release-trigger-minor/release.properties).
